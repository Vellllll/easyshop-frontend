        ...
        <Card>
            <Card.Body>
                <Row>
                    ...
                    <img className="cart-product-img" src="https://image.uniqlo.com/UQ/ST3/id/imagesgoods/425974/item/idgoods_09_425974.jpg?width=320" />
                    </Col>
                    ...
                    <Button className="btn btn-block w-100 mt-3  site-btn"><i className="fa fa-trash-alt"></i> Remove
                    </Button>
